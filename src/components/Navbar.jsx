...
function Navbar() {
  ...
  return (
    <div className=' flex justify-between  m-auto  max-w-[1640px] items-center  p-4'>
      ...
      {/* Side drawer menu */}
      <div className= {
        nav ? 'fixed top-0 left-0 w-[250px] h-screen bg-white z-10 duration-300 transition-all '
          :
        'fixed top-0 left-[-100%] w-[250px] h-screen bg-white z-10 duration-300 transition-all'
      }>
        <AiOutlineClose onClick={()=> {
          ...
          <nav>
                <ul className='flex flex-col p-4 text-gray-800'>
                    <li className='text-xl py-4 flex   cursor-pointer     duration-300 ease-in    transition'><TbTruckDelivery size={25} className='mr-4 cursor-pointer' /> <NavLink to="/">Home</NavLink></li>
                    <li className='text-xl py-4 flex   cursor-pointer    duration-300 ease-in  transition'><MdFavorite size={25} className='mr-4 cursor-pointer' /> <NavLink to="/servies">Services</NavLink></li>
                    <li className='text-xl py-4 flex   cursor-pointer    duration-300 ease-in  transition'><FaWallet size={25} className='mr-4 cursor-pointer' /><NavLink  to="/about"> About</NavLink></li>
                </ul>
            </nav>
    </div>
    </div>
